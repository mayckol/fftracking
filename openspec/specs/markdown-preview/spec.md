...
Provide Markdown view modes (Raw / Both / Read) in the editor pane via a top-right toolbar shown only for Markdown files, with live sanitized HTML preview and Mermaid diagram rendering. Non-Markdown files are unaffected.
