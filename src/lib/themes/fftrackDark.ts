...
export const fftrackDark: Theme = {
  ...
  monaco: {
    ...
    colors: {
      ...
      "menu.selectionBackground": "#283450",
      "menu.selectionForeground": "#e6edf3",
      "menu.separatorBackground": "#2b3744",
      "menu.border": "#2b3744",
      // Command palette / quick-input (F1, ⌘P) — also shadow-root rendered.
      "focusBorder": "#7c8cff",
      "widget.shadow": "#00000066",
      "editorWidget.background": "#141a21",
      "editorWidget.foreground": "#e6edf3",
      "editorWidget.border": "#2b3744",
      "input.background": "#0e1116",
      "input.foreground": "#e6edf3",
      "input.border": "#2b3744",
      "inputOption.activeBorder": "#7c8cff",
      "quickInput.background": "#141a21",
      "quickInput.foreground": "#e6edf3",
      "quickInputList.focusBackground": "#283450",
      "quickInputList.focusForeground": "#e6edf3",
      "list.focusBackground": "#283450",
      "list.focusForeground": "#e6edf3",
      "list.hoverBackground": "#19222c",
      "list.highlightForeground": "#93a0ff",
      "pickerGroup.foreground": "#5d6b7a",
      "pickerGroup.border": "#2b3744",
      "keybindingLabel.background": "#1b232d",
      "keybindingLabel.foreground": "#9aa7b4",
      "keybindingLabel.border": "#2b3744",
      "keybindingLabel.bottomBorder": "#2b3744",
    },
  },
};
