...
export const tokyoNight: Theme = {
  ...
  monaco: {
    ...
    colors: {
      ...
      "menu.selectionBackground": "#2e3a5c",
      ...
      "editorWidget.border": "#363b54",
      "input.background": "#16161e",
      "input.foreground": "#c0caf5",
      "input.border": "#363b54",
      "inputOption.activeBorder": "#7aa2f7",
      "quickInput.background": "#1e202e",
      "quickInput.foreground": "#c0caf5",
      "quickInputList.focusBackground": "#2e3a5c",
      "quickInputList.focusForeground": "#c0caf5",
      "list.focusBackground": "#2e3a5c",
      "list.focusForeground": "#c0caf5",
      "list.hoverBackground": "#242a3f",
      "list.highlightForeground": "#9ab8ff",
      "pickerGroup.foreground": "#787c99",
      "pickerGroup.border": "#363b54",
      "keybindingLabel.background": "#24283b",
      "keybindingLabel.foreground": "#a9b1d6",
      "keybindingLabel.border": "#363b54",
      "keybindingLabel.bottomBorder": "#363b54",
    },
  },
};
